...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thuadapter = new qlthuadapter(MainActivity.this,R.layout.thuchi_listview_item,arraythu);
        ...
        chiadapter = new qlchiadapter(MainActivity.this,R.layout.thuchi_listview_item,arraychi);
    ...
    private void setDialogDeleteItemThu(int position){
        ...
        ab.setTitle("Xóa mục");
        ab.setMessage("Bạn có muốn xóa mục này không?");
    ...
    private void setDialogDeleteItemChi(int position){//click vào item bên chi sẽ xóa
        AlertDialog.Builder ab = new AlertDialog.Builder(MainActivity.this);
        ab.setTitle("Xóa mục");
        ab.setMessage("Bạn có muốn xóa mục này không?");
        ab.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
